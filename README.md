...
1. Create `.env.local` file that looks like so if it does not already exist:
   ...
   ```shell
    ...
    REACT_APP_SENTRY_DSN="https://cf4ab46e192d45a3b2a9bd20992b97e7@o542263.ingest.sentry.io/5661777"
...
[build-status-image]: https://img.shields.io/github/workflow/status/evsWorld/test2/Deploy?style=flat-square
[build-status-url]: https://github.com/evsWorld/test2/actions
[coverage-image]: https://img.shields.io/codecov/c/github/evsWorld/test2.svg?style=flat-square
[coverage-url]: https://codecov.io/gh/evsWorld/test2
[license-image]: https://img.shields.io/github/license/evsWorld/test2?style=flat-square
[license-url]: https://github.com/evsWorld/test2/blob/master/LICENSE
